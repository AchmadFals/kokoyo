          ...
          <p className="text-stone-400 text-3xl text-center pb-2 text-black font-lato text-3xl font-semibold">Register</p>
            <div className="form-body">
                <div className="fullname pb-2">
                    <label className="form__label block flex font-bold text-neutral-500" for="fullName">Full Name</label>
                ...
                <div className="username pb-2">
                    <label className="form__label block flex font-bold text-neutral-500" for="userName">Username</label>
                ...
                <div className="email pb-2">
                    <label className="form__label block flex font-bold text-neutral-500" for="email">Email</label>
                ...
                <div className="password pb-2">
                    <label className="form__label block flex font-bold text-neutral-500" for="password">Password</label>
                ...
                <div className="confirm-password pb-3">
                    <label className="form__label block flex font-bold text-neutral-500" for="confirmPassword">Confirm Password</label>
